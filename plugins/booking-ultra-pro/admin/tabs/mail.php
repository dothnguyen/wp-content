...
$this->create_plugin_setting(
	...
	array(
		...
		'smtp' => __('Send all Users Ultra emails via SMTP','bookingup'), 
		'mandrill' => __('Send all Users Ultra emails via Mandrill','bookingup'),
		'third-party' => __('Send all Users Ultra emails via Third-party plugin','bookingup'), 
...
<div class="bup-sect  ">
  <h3><?php _e('Reschedule Message','bookingup'); ?></h3>
  
  <p><?php _e('This message is sent when an appointment is rescheduled.','bookingup'); ?></p>
